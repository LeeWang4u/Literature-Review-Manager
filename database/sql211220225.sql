...
CREATE TABLE `ai_summaries` (
  ...
  CONSTRAINT `FK_2036692563883954f0e322991ed` FOREIGN KEY (`paper_id`) REFERENCES `papers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `citations` (
  ...
  CONSTRAINT `FK_868a38a39584b6022353f182f78` FOREIGN KEY (`citing_paper_id`) REFERENCES `papers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4276 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `library_papers`
--

DROP TABLE IF EXISTS `library_papers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `library_papers` (
  ...
  KEY `fk_lp_paper` (`paper_id`),
  CONSTRAINT `fk_lp_library` FOREIGN KEY (`library_id`) REFERENCES `libraries` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_lp_paper` FOREIGN KEY (`paper_id`) REFERENCES `papers` (`id`) ON DELETE CASCADE
...
CREATE TABLE `notes` (
  ...
  CONSTRAINT `FK_58ae99c11416e89c6ca52a05328` FOREIGN KEY (`paper_id`) REFERENCES `papers` (`id`) ON DELETE CASCADE
...
) ENGINE=InnoDB AUTO_INCREMENT=3988 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-20 22:46:27
